...
function Creature6Arms(radius, color, angle, angularVelocity, planetX, planetY, rotationalRadius, armSegmentNumber) {
  this.color = color;
  this.radius = radius;
...
Creature6Arms.prototype.update = function(x, y) {
  this.planetX = x;
  this.planetY = y;
...
Creature6Arms.prototype.draw = function() {
...
Creature6Arms.prototype.updateSegments = function() {
  var a = 1;
...
Creature6Arms.prototype.drawSegments = function() {
  ctx.strokeStyle = "black";
  ctx.fillStyle = this.color;
...
Creature6Arms.prototype.run = function(x, y) {
  this.update(x, y);
  this.draw();
  this.drawSegments();
}
